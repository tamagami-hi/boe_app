...
vi.mock('./legacy/legacyRoutes.jsx', () => ({
  ...
  MandateDetailRoute: () => <div data-testid="page-mandate-detail" />,
  ...
  FundReceiptsRoute: ({ tab }) => <div data-testid={`page-fund-receipts-${tab}`} />,
...
describe('Admin route table', () => {
  const routeCases = [
    ...
    ['/admin/funds-received/awaiting', 'page-fund-receipts-awaiting'],
    ['/admin/funds-received/acknowledged', 'page-fund-receipts-acknowledged'],
    ['/admin/funds-received/refunds', 'page-fund-receipts-refunds'],
    ...
    ['/admin/payments/mandates', 'page-mandates'],
    ['/admin/payments/mandates/m1', 'page-mandate-detail'],
...
describe('Admin retired-route redirects', () => {
  const redirectCases = [
    ...
    ['/admin/ops/sip-control', 'page-mandates'],
