...
export const SECTION_HEAD_TITLE =
...
export const GATE_TITLE = [
  "m-0 font-display font-light text-page text-fg",
  "[text-wrap:balance]",
].join(" ")
...
export const ACTION_GROUP = "flex flex-col gap-3"

export const ACTION_DANGER_ROW = [
