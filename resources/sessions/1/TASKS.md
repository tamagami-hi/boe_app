...
| BE-007 Canonical identity/onboarding schema | ACTIVE (BE-007a/b/c/d DONE; BE-007e next) | BE-004, BE-005 | Split into child packets. **BE-007a** (`009` onboarding) + **BE-007b** (`010` identity) + **BE-007c** (`011` sessions) + **BE-007d** (`012` RBAC/audit/idempotency/rate-limit/legal-holds) DONE, applied+asserted on PG (integration 12/12); next: outbox/email, repositories, bootstrap seed |
