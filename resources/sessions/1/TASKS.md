...
| BE-007 Canonical identity/onboarding schema | ACTIVE (BE-007a/b/c/d/e DONE; BE-007f next) | BE-004, BE-005 | Split into child packets. **BE-007a** (`009` onboarding) + **BE-007b** (`010` identity) + **BE-007c** (`011` sessions) + **BE-007d** (`012` RBAC/audit/idempotency/rate-limit/legal-holds) + **BE-007e** (`013` outbox/email delivery) DONE, applied+asserted on PG (integration 13/13); next: Kysely repositories, bootstrap seed |
