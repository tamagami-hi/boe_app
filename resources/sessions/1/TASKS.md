...
| BE-007 Canonical identity/onboarding schema | ACTIVE (BE-007a DONE; BE-007b next) | BE-004, BE-005 | Additive PostgreSQL schema/repositories/concurrency tests; split into child packets. **BE-007a** public-onboarding schema DONE (migration `009`, applied+asserted on PG); next: `users`/sessions/RBAC tables + repositories |
