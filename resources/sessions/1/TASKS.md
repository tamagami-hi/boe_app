...
| BE-007 Canonical identity/onboarding schema | ACTIVE (BE-007a/b/c DONE; BE-007d next) | BE-004, BE-005 | Split into child packets. **BE-007a** (`009` onboarding) + **BE-007b** (`010` identity) + **BE-007c** (`011` sessions: auth_sessions/auth_refresh_tokens) DONE, applied+asserted on PG (integration 11/11); next: RBAC/audit/idempotency/rate-limit/legal-holds, outbox/email, repositories, bootstrap seed |
