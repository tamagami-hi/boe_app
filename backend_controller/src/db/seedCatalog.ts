...
export const SEED_PERMISSIONS: readonly SeedPermission[] = [
  ...
  { code: "funds.write", description: "Create funds and publish catalog versions and disclosures" },
  { code: "finance.read", description: "Read finance projections" },
  { code: "finance.operate", description: "Operate finance workflows" },
  { code: "payments.read", description: "Read payments and their attempts" },
  { code: "funds.receipts.read", description: "Read received fund acknowledgements" },
  { code: "funds.receipts.write", description: "Acknowledge received client funds" },
  { code: "refunds.write", description: "Initiate and manage refund operations" },
  { code: "client_values.read", description: "Read client value entries" },
  { code: "clients.create", description: "Create a client account without a public signup" },
  { code: "client_growth.write", description: "Post client growth adjustment batches" },
  { code: "client_position.write", description: "Record contributions, settle maturities, manage payouts and reverse ledger entries" },
  { code: "aum.read", description: "Read fund AUM snapshots" },
  { code: "aum.write", description: "Publish AUM growth instructions and snapshots" },
