...
export const SEED_PERMISSIONS: readonly SeedPermission[] = [
  ...
  { code: "investments.review.read", description: "Read the investment review queue" },
  { code: "investments.review.write", description: "Accept or reject an investment review" },
...
export const SEED_ROLE_PERMISSIONS: Readonly<Record<string, readonly string[]>> = {
  ...
  finance: [
    ...
    "approvals.check",
    "payments.read",
    "investments.review.read",
    "investments.review.write",
    "refunds.write",
    "client_values.read",
    "client_growth.write",
    "aum.read",
