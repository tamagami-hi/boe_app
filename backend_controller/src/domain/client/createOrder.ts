 ...
 *
 * SIP-installment orders are system-generated by the (later) SIP scheduler;
 * this command creates only client-initiated `purchase` orders.
 */
...
export const createOrder = async (
  ...
  if (terms.fundState !== "published" || terms.minimumPurchasePaise === null) {
    throw new AppError("STATE_CONFLICT")
  }
  ...
  await deps.auditRepository.append(tx, {
    ...
    metadata: { type: "purchase", fundId: input.fundId },
  })
  return order
}
